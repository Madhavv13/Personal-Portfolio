...
function Project() {
  ...
  return (
    ...
    <div className='project_info'>
      <div className='pr 1'>
          <div className='im 1'>
            <img src="assests\pixel sketch.jpg" alt="" height={220} width={250}/>
          </div>
      ...
      <div className='pr 2'>
          <div className='im 2'>
            <img src="assests\rock.png" alt="" height={220} width={250}/>
          </div>
      ...
      <div className='pr 3'>
          <div className='im 3'>
            <img src="assests\responsive.png" alt="" height={220} width={250}/>
          </div>
